...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Soundtest_ref.rsp
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/Soundtest \
...
DAHostLib_rtw.obj : $(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/src/DAHostLib_rtw.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/src/DAHostLib_rtw.c

HostLib_MMFile.obj : $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_MMFile.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_MMFile.c

HostLib_Multimedia.obj : $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_Multimedia.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_Multimedia.c
